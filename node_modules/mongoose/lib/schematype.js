 ...
 * the value is not null nor undefined). However, most built-in mongoose schemas
...
SchemaType._isRef = function(self, value, doc, init) {
  ...
  if (!ref && doc && doc.$__fullPath) {
    // checks for
    // - this populated with adhoc models and no ref was set in schemas OR
