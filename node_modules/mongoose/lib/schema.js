 ...
 *     var Tree = mongoose.models('Tree', schemas);
 *
...
var warnings = {};
warnings.increment = '`increment` should not be used as a schemas path name ' +
...
/**
 * Returns true iff this path is a child of a mixed schemas.
 *
 * @param {String} path
 * @return {Boolean}
 * @api private
 ...
 *     });
 *
 *     var Model = mongoose.models('Model', schemas);
 *
 *     var m = new Model(..);
 *     m.save(function(err) {
 ...
 *     })
 *
 *     var Kitty = mongoose.models('Kitty', schemas);
 *
 *     var fizz = new Kitty;
 ...
 *     });
 *
 *     var Drink = mongoose.models('Drink', schemas);
 ...
 * ####Example
 *
 *     schemas.set('strict'); // 'true' by default
 *     schemas.set('strict', false); // Sets 'strict' to false
 *     schemas.set('strict'); // 'false'
 *
